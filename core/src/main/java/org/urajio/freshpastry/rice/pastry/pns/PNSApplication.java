...
//  }
    ...
    public Cancellable getNearest(final NodeHandle seed, final Continuation<Collection<NodeHandle>, Exception> retToMe) {
        ...
        ret.attach(getLeafSet(seed, new Continuation<LeafSet, Exception>() {
            ...
            public void receiveResult(LeafSet result) {
                ...
                ret.attach(closestToMe(seed, result, new Continuation<NodeHandle, Exception>() {
                    ...
                    public void receiveResult(NodeHandle result) {
                        ...
                        ret.attach(seekThroughRouteRows(i, depth, result, new Continuation<NodeHandle, Exception>() {
