 ...
 * @author Alan Mislove
 */
public class Id implements org.urajio.freshpastry.rice.p2p.commonapi.Id, RawSerializable {
   ...
   * @throws IOException
   */
  public static Id build(org.urajio.freshpastry.rice.p2p.commonapi.rawserialization.InputBuffer buf) throws IOException {
  ...
  public void serialize(org.urajio.freshpastry.rice.p2p.commonapi.rawserialization.OutputBuffer buf) throws IOException {
      for (int value : Id) {
          buf.writeInt(value);
      }
  }
   ...
   * @return true if this is between ccw (inclusive) and cw (exclusive), false otherwise
   */
  public boolean isBetween(org.urajio.freshpastry.rice.p2p.commonapi.Id ccw, org.urajio.freshpastry.rice.p2p.commonapi.Id cw) {
...
//  }
   ...
   */
  public int compareTo(org.urajio.freshpastry.rice.p2p.commonapi.Id obj) {
    Id oth = (Id) obj;
...
//  }
   ...
   * @return true if clockwise, false otherwise.
   */
  public boolean clockwise(org.urajio.freshpastry.rice.p2p.commonapi.Id nid) {
   ...
   * @return the new Id
   */
  public org.urajio.freshpastry.rice.p2p.commonapi.Id addToId(org.urajio.freshpastry.rice.p2p.commonapi.Id.Distance offset) {
   ...
   * @return the distance between this and nid.
   */
  public org.urajio.freshpastry.rice.p2p.commonapi.Id.Distance distanceFromId(org.urajio.freshpastry.rice.p2p.commonapi.Id nid) {
   ...
   * @return the distance between this and nid.
   */
  public org.urajio.freshpastry.rice.p2p.commonapi.Id.Distance longDistanceFromId(org.urajio.freshpastry.rice.p2p.commonapi.Id nid) {
   ...
   * @author amislove
   */
  public static class Distance implements org.urajio.freshpastry.rice.p2p.commonapi.Id.Distance {
     ...
     * @return negative if this < obj, 0 if they are equal and positive if this > obj.
     */
    public int compareTo(org.urajio.freshpastry.rice.p2p.commonapi.Id.Distance obj) {
     ...
     * @return this
     */
    public org.urajio.freshpastry.rice.p2p.commonapi.Id.Distance shiftDistance(int cnt, int fill) {
